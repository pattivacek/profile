...
" pvacek: Originally obtained from here:
...
nmap <F7> :python fortran_complete()<cr>:noh<cr>A
imap <F7> :python fortran_complete()<cr>:noh<cr>A

else
    nmap <F7> a then<CR>endif<ESC>O
    imap <F7>  then<CR>endif<ESC>O
endif
